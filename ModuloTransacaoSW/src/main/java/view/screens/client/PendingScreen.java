...
public class PendingScreen extends RoundedFrame {
    private static PendingScreen instance;
    private final MenuScreen menuScreen;
    private final TransferScreen transferScreen;
    private final BankController bankController;
    private final int accountRecieverId;

    private PendingScreen(BankController bankController, MenuScreen menuScreen, TransferScreen transferScreen, int accountRecieverId) {
    ...
    public static PendingScreen getInstance(BankController bankController, MenuScreen menuScreen, TransferScreen transferScreen, int accountRecieverId) {
        if (instance == null) {
            instance = new PendingScreen(bankController, menuScreen, transferScreen, accountRecieverId);
        }
        return instance;
    }
    ...
    private JLayeredPane createLayeredPane() {
        ...
        try {
            File file = new File("src/main/resources/images/TransferPendingScreen.png");
