...
public class ManagerTransferRejectedScreen extends RoundedFrame {
    private static ManagerTransferRejectedScreen instance;
    private final BankControllerManager bankControllerManager;

    private ManagerTransferRejectedScreen(BankControllerManager bankControllerManager) {
        super("Transação Rejeitada", 540, 900, 40, 40);
    ...
    public static ManagerTransferRejectedScreen getInstance(BankControllerManager bankControllerManager) {

        if (instance == null) {
            instance = new ManagerTransferRejectedScreen(bankControllerManager);
        }
        return instance;
    }
    ...
    private JLayeredPane createLayeredPane() {
        ...
        try {
            File file = new File("src/main/resources/images/ManagerTransferRejectedScreen.png");
